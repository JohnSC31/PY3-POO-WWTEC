...
public class Aerial extends Army{
    ...
    public Aerial(String name, ImageIcon aparence, int live, int hit, int level, int spaces, int apparitionLevel, int price) {
        super(name, aparence, live, hit, level, spaces, apparitionLevel, price);
    }
